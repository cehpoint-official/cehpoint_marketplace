...
import 'package:cehpoint_marketplace/navigation/bottomNavigationItems/profilePage/profile_controller.dart';
import 'package:cehpoint_marketplace/navigation/bottomNavigationItems/widgets.dart';
...
class ProfilePage extends StatelessWidget {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      controller.index == 0
                          ? _miniProfile(controller, context)
  ...
  Widget _miniProfile(ProfileController controller, BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(
          color: Colors.white,
