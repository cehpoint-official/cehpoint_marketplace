...
import 'package:cehpoint_marketplace/navigation/bottomNavigationItems/paymentsPage/payments_page_controller.dart';
    ...
    return const Column(
      children: [
        ...
        Padding(
          padding: EdgeInsets.all(8.0),
          child: Text(
            "Cehpoint's Secure Payment System: Ensuring Your Transactions are Protected",
