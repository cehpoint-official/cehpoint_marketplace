...
class GlobalUtil {
  ...
  static const int appIdForCalling = 821820474;
  ...
  static const String visitUrl = 'https://help.cehpointmarketplace.com';
  static const String contactEmail = 'customercare@cehpointmarketplace.com';
...
// Function to generate a random dark color
  ...
  static String formatPrice(String price) {
    ...
    if (value >= 10000000) {
      ...
      return 'INR ${(value / 1000).toStringAsFixed(2)} K';
    } else {
